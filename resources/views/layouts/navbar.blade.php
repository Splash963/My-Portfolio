        ...
        <div class="container">
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav pt-3 pb-3" style="gap: 1em;">
                    ...
                    @endguest
                    @auth
                        <li class="nav-item user-name-wrapper">
                            ...
                            <form action="{{ route('logout') }}" method="POST" class="d-inline m-0 p-0">
                                ...
                                <button type="submit" class="nav-logout-btn">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="currentColor" class="bi bi-box-arrow-right me-1" viewBox="0 0 16 16">
                ...
                <ul class="navbar-nav pt-3 pb-3 ms-auto flex-row" style="gap: 1em;">
                    <li class="nav-item">
                        <a href="nav-link" href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="#ffffffff"
