        ...
        <div class="container text-center">
            <div class="row">
                <div class="col-12 col-lg-6 d-flex flex-column justify-content-center align-items-center column-01">
                    <div class="title">
                        ...
                        <h2 data-aos="fade-up" class="">
                            I am a <span class="typed subtitle"
                                data-typed-items="UI/UX Designer, Web Developer, WordPress Developer, Mobile App Developer"></span>
                        </h2>
                        <p class="description">I am a multi-disciplinary designer and developer dedicated
                            to building products that work as beautifully as they look.
                            With a background spanning UI/UX Design, Web Design, and Mobile App Development,
                ...
                <div class="col-12 col-lg-6 d-flex justify-content-center">
                    <div>
                        <img src="{{ asset('profille/my-img.jpeg') }}" alt="Profile Image"
