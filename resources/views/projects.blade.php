                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card project-card border-0 h-100 bg-dark-card shadow">
                        <div class="position-relative overflow-hidden project-img-wrapper">
                            ...
                            @else
                                <img src="{{ asset('images/project1.jpg') }}" class="card-img-top" alt="Placeholder">
                            @endif
                            <div class="project-overlay d-flex align-items-center justify-content-center">
                                @if($project->link)
                                    <a href="{{ $project->link }}" target="_blank" class="btn btn-outline-accent rounded-circle icon-btn"><i class="fa-solid fa-link"></i></a>
                                @endif
                            </div>
                        </div>
                        <div class="card-body p-4">
                            ...
                            @if($project->link)
                                <a href="{{ $project->link }}" target="_blank" class="btn btn-accent px-4 py-2 rounded-bill shadow-sm w-100 fw-bold">View Case Study</a>
                            @endif
                        </div>
                    </div>
                </div>
